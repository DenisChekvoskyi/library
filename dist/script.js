...
/*!*********************************************************!*\
  !*** C:/Users/Denis/node_modules/jquery/dist/jquery.js ***!
  \*********************************************************/
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.find = function (selector) {
  ...
  for (let i = 0; i < copeObj.length; i++) {
    const arr = copeObj[i].querySelectorAll(selector);
    if (arr.length === 0) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.delAtr = function (name) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animatedOverTime = function (dur, cb, fin) {
  let timeStart;
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])("#trigger").click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])("#trigger").createModal({
  ...
  btns: {
    count: 3,
    settings: [["Close", ["btn-danger", "mr-10"], true], ["Save", ["btn-success"], false, () => alert("Ok")], ["Click me", ["btn-warning", "ml-10"], false, () => alert("Thanks")]]
  }
}));
